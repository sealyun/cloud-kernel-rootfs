...
///cni/calico/calico.yaml.tmpl
const calicoYamlTemplate = `---
...
func (c *Calico) Template() string {
	return calicoYamlTemplate
}

func (c *Calico) TemplateConvert() string {
	p := map[string]interface{}{
		"CniRepo":   "calico",
		"CIDR":      "100.64.0.0/10",
		"Interface": "interface=eth.*|en.*",
		"IPIP":      true,
		"MTU":       "1440",
	}

	data, err := templateFromContent(c.Template(), p)
	if err != nil {
		logger.Error(err)
		return ""
	}
